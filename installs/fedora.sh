...
packages="neovim livestreamer weechat tmux conky zsh firefox ranger rofi the_silver_searcher terminator docker docker-compose emacs code wine php python-pip youtube-dl"
